...
try:
    while True:
        ...
        motor1_foward(60)  # Faire tourner le premier moteur dans le sens anti-horaire à 60% de sa vitesse
        motor2_foward(40)  # Faire tourner le deuxième moteur dans le sens anti-horaire à 40% de sa vitesse
        time.sleep(2)
